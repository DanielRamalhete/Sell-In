...
SRC_FILE_PATH = "/General/Teste - Daniel PowerAutomate/Visitas Wize Mensal.xlsx"
DST_FILE_PATH = "/General/Teste - Daniel PowerAutomate/Visitas Wize.xlsx"

DATE_COLUMN   = "Data Visita"
# ==========================
...
print("Source columns:", [c.value for c in next(wb_src[SRC_SHEET].iter_rows(min_row=1, max_row=1))])
wb_src.close()
wb_dst.close()
...
print(f"Source columns: {df_src.columns.tolist()}")
...
if to_import.empty:
    ...
    # Remove two month window from destination
